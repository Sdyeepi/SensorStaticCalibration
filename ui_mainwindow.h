...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gBoxInput->setGeometry(QRect(10, 10, 581, 351));
        ...
        gBoxLsm->setGeometry(QRect(600, 10, 561, 201));
        ...
        gBoxBiPoint->setGeometry(QRect(600, 220, 561, 201));
        ...
        label_7 = new QLabel(gBoxBiPoint);
        ...
        gViewOrigin->setGeometry(QRect(20, 430, 571, 351));
        lineEdit = new QLineEdit(centralwidget);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setEnabled(true);
        lineEdit->setGeometry(QRect(210, 790, 771, 25));
        ...
        QWidget::setTabOrder(lineEdit81, lineEdit12);
        ...
        QWidget::setTabOrder(lineEdit82, lineEdit13);
        ...
        QWidget::setTabOrder(lineEdit83, lineEdit14);
        ...
        QWidget::setTabOrder(lineEdit84, lineEdit15);
        ...
        QWidget::setTabOrder(lineEdit85, lineEdit16);
        ...
        QWidget::setTabOrder(lineEdit86, lineEdit17);
        ...
        QWidget::setTabOrder(lineEdit87, lineEditK);
        QWidget::setTabOrder(lineEditK, pBtnUpdate);
        QWidget::setTabOrder(pBtnUpdate, lineEditLsmB1);
